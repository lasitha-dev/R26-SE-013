...
class ForecastFollowUpRecord(BaseModel):
    ...
    probability: Optional[float] = Field(default=None, description="Frozen forecast outbreak probability (snapshot).")
    predicted_severity: Optional[str] = Field(default=None, description="Frozen predicted severity category (snapshot).")
    fallback_applied: Optional[bool] = Field(default=None, description="Frozen fallback applied flag (snapshot).")
