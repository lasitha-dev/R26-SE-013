...
import { sriLankanBreeds, allBreeds } from './AddNewAnimal.jsx'
...
export default function SettingsFarmConfiguration() {
  ...
  useEffect(() => {
    ...
    const fallbacks = breedDefaults[selectedBreed] || { milk: '15.0', weight: '450.0' }
    if (match) {
      setBreedAvgMilk(match.avg_milk !== null ? match.avg_milk.toString() : fallbacks.milk)
      setBreedAvgWeight(match.avg_weight !== null ? match.avg_weight.toString() : fallbacks.weight)
    } else {
      setBreedAvgMilk(fallbacks.milk)
      setBreedAvgWeight(fallbacks.weight)
    }
