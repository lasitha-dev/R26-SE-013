...
describe('Guarded App Entry & Routing Tests (App.jsx)', () => {
  ...
  it('8. default existing app path (/) renders standard RiskForecasting feature module inside AppShell', async () => {
    import.meta.env.VITE_FORECASTING_DEMO_ENABLED = 'false';
    setWindowLocation('/');
    ...
    await waitFor(() => {
      expect(screen.getByText('Seasonal Risk Forecasting')).toBeInTheDocument();
    });
