 ...
 */
const TopHeader = ({ title = 'Seasonal Risk Forecasting', onMenuToggle }) => {
  return (
    <header
      className="w-full sticky top-0 z-30 bg-surface-container-low flex justify-between items-center px-4 md:px-8 h-16 border-b border-outline-variant/10"
      id="top-header"
      role="banner"
    >
